...
#include "GanaKaragandaWidget.generated.h"

/**
 *
 */
UCLASS()
class NEWSTATIONDISPETCHER_API UGanaKaragandaWidget : public UUserWidget
{
	GENERATED_BODY()
...
#pragma endregion
	...
	UPROPERTY(meta = (BindWidget))
		class UHorizontalBox* HB_LocoOdd_tupic_M_9;
	...
	UPROPERTY(meta = (BindWidget))
		class UHorizontalBox* HB_LocoEven_tupic_M_9;
	...
	UPROPERTY(meta = (BindWidget))
		class UButton* Button_TrainInfo_tupic_M_9;
	...
	UPROPERTY(meta = (BindWidget))
		class UTextBlock* TextButton_tupic_M_9;
	...
	UPROPERTY(meta = (BindWidget))
		class UTextBlock* TB_LocoOdd_tupic_M_9;
	...
	UPROPERTY(meta = (BindWidget))
		class UTextBlock* TB_LocoEven_tupic_M_9;
...
#pragma region General Foo
	...
	UFUNCTION(BlueprintCallable)
		void gk_StrelkiWaysSvetoforDefault();
	...
	UFUNCTION()
		void CreateMenuTrainInfo_tupic_M9();
	...
	UFUNCTION(BlueprintCallable)
		void gk_WayNumberChanger(int numberway);
...
#pragma region Strelki
	...
	UFUNCTION(BlueprintCallable)
		int gk_Make_Strelka_Redact(int number);

	UFUNCTION(BlueprintCallable)
		void gk_Make_Strelka_UnRedact();

	UFUNCTION(BlueprintCallable)
		void gk_RedactStrelkaToMinus();

	UFUNCTION(BlueprintCallable)
		void gk_RedactStrelkaToPlus();

	UFUNCTION(BlueprintCallable)
		void gk_RedactStrelkaToBreak();

	UFUNCTION(BlueprintCallable)
		void gk_RedactStrelkaMakeWaitingAvaria();

	UFUNCTION(BlueprintCallable)
		void gk_RedactStrelkaRemont();

	UFUNCTION(BlueprintCallable)
		void gk_RemontAllStrelka();
...
#pragma region Svetofori
	...
	UFUNCTION(BlueprintCallable)
		void gk_Make_Svetofor_Redact(EdopStat dopstat);
	EdopStat gk_Get_Name_Redact_Svetofor();
	UFUNCTION(BlueprintCallable)
		bool gk_IsRedactSvetoforFree();


	UFUNCTION(BlueprintCallable)
		void gk_Make_Svetofor_UnRedact();
	UFUNCTION(BlueprintCallable)
		void gk_BrokenSvetoforMake(ExCurator cur);
	UFUNCTION(BlueprintCallable)
		void gk_RedactSvetofor_Remont();
	UFUNCTION(BlueprintCallable)
		void gk_AllSvetofor_Remont();

#pragma endregion

#pragma region Signals
	UFUNCTION(BlueprintCallable)
		void gk_RazvorotPeregona(EdopStat dopstat);
	UFUNCTION(BlueprintCallable)
		void gk_VspomogatRazvorotPeregona(EdopStat dopstat);
#pragma endregion
...
#pragma region from N
	UFUNCTION(BlueprintCallable)
		bool gk_N_1P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N_2P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N_3P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N_4P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N_5P_CheckPossCreate();


#pragma endregion
#pragma region from ND
	UFUNCTION(BlueprintCallable)
		bool gk_ND_1P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_ND_2P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_ND_3P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_ND_4P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_ND_5P_CheckPossCreate();


#pragma endregion
#pragma region from CH
	UFUNCTION(BlueprintCallable)
		bool gk_CH_1P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH_2P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH_3P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH_4P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH_5P_CheckPossCreate();


#pragma endregion
#pragma region from CHD
	UFUNCTION(BlueprintCallable)
		bool gk_CHD_1P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CHD_2P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CHD_3P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CHD_4P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CHD_5P_CheckPossCreate();
...
#pragma region from M1
	UFUNCTION(BlueprintCallable)
		bool gk_M1_CH1_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M1_CH2_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M1_CH3_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M1_CH4_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M1_CH5_CheckPossCreate();


#pragma endregion
#pragma region from M2
	UFUNCTION(BlueprintCallable)
		bool gk_M2_N1_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M2_N2_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M2_N3_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M2_N4_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M2_N5_CheckPossCreate();
...
#pragma region from M3
	UFUNCTION(BlueprintCallable)
		bool gk_M3_CH1_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M3_CH2_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M3_CH3_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M3_CH4_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M3_CH5_CheckPossCreate();


#pragma endregion
#pragma region from M4
	UFUNCTION(BlueprintCallable)
		bool gk_M4_N1_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M4_N2_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M4_N3_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M4_N4_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_M4_N5_CheckPossCreate();


#pragma endregion
#pragma region from M5
	UFUNCTION(BlueprintCallable)
		bool gk_M5_CH5_CheckPossCreate();
...
#pragma region from CH1
	UFUNCTION(BlueprintCallable)
		bool gk_CH1_M1_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH1_M3_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH1_N_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH1_ND_CheckPossCreate();
#pragma endregion
#pragma region from CH2
	UFUNCTION(BlueprintCallable)
		bool gk_CH2_M1_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH2_M3_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH2_N_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH2_ND_CheckPossCreate();
#pragma endregion
#pragma region from CH3
	UFUNCTION(BlueprintCallable)
		bool gk_CH3_M1_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH3_M3_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH3_N_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH3_ND_CheckPossCreate();
#pragma endregion
#pragma region from CH4
	UFUNCTION(BlueprintCallable)
		bool gk_CH4_M1_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH4_M3_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH4_N_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH4_ND_CheckPossCreate();
#pragma endregion
#pragma region from CH5
	UFUNCTION(BlueprintCallable)
		bool gk_CH5_M1_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH5_M3_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH5_N_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH5_M5_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_CH5_ND_CheckPossCreate();
#pragma endregion


#pragma region from N1
	UFUNCTION(BlueprintCallable)
		bool gk_N1_M2_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N1_M4_CheckPossCreate();

	UFUNCTION(BlueprintCallable)
		bool gk_N1_CH_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N1_CHD_CheckPossCreate();

#pragma endregion
#pragma region from N2
	UFUNCTION(BlueprintCallable)
		bool gk_N2_M2_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N2_M4_CheckPossCreate();

	UFUNCTION(BlueprintCallable)
		bool gk_N2_CH_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N2_CHD_CheckPossCreate();

#pragma endregion
#pragma region from N3
	UFUNCTION(BlueprintCallable)
		bool gk_N3_M2_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N3_M4_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N3_CH_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N3_CHD_CheckPossCreate();

#pragma endregion
#pragma region from N4
	UFUNCTION(BlueprintCallable)
		bool gk_N4_M2_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N4_M4_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N4_CH_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N4_CHD_CheckPossCreate();

#pragma endregion
#pragma region from N5
	UFUNCTION(BlueprintCallable)
		bool gk_N5_M2_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N5_M4_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N5_CH_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool gk_N5_CHD_CheckPossCreate();
...
#pragma endregion
	...
	FElm* gk_GetEndRouter(Router* router);

	//Router* gk_GetReadyRouter(EdopStat dopstat);

	UFUNCTION(BlueprintCallable)
		void gk_IskusstvennaiyaRazdelka();
