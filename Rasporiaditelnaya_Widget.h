...
#include "Rasporiaditelnaya_Widget.generated.h"

/**
 * 
 */
UCLASS()
class NEWSTATIONDISPETCHER_API URasporiaditelnaya_Widget : public UUserWidget
{
	GENERATED_BODY()
...
#pragma region General Foo
	...
	UFUNCTION(BlueprintCallable)
		void rs_StrelkiWaysSvetoforDefault();
...
#pragma region Strelki
	...
	UFUNCTION(BlueprintCallable)
		int rs_Make_Strelka_Redact(int number);

	UFUNCTION(BlueprintCallable)
		void rs_Make_Strelka_UnRedact();

	UFUNCTION(BlueprintCallable)
		void rs_RedactStrelkaToMinus();

	UFUNCTION(BlueprintCallable)
		void rs_RedactStrelkaToPlus();

	UFUNCTION(BlueprintCallable)
		void rs_RedactStrelkaToBreak();

	UFUNCTION(BlueprintCallable)
		void rs_RedactStrelkaMakeWaitingAvaria();

	UFUNCTION(BlueprintCallable)
		void rs_RedactStrelkaRemont();

	UFUNCTION(BlueprintCallable)
		void rs_RemontAllStrelka();
...
#pragma region Svetofori
	...
	UFUNCTION(BlueprintCallable)
		void rs_Make_Svetofor_Redact(EdopStat dopstat);
	EdopStat rs_Get_Name_Redact_Svetofor();
	UFUNCTION(BlueprintCallable)
		bool rs_IsRedactSvetoforFree();


	UFUNCTION(BlueprintCallable)
		void rs_Make_Svetofor_UnRedact();
	UFUNCTION(BlueprintCallable)
		void rs_BrokenSvetoforMake(ExCurator cur);
	UFUNCTION(BlueprintCallable)
		void rs_RedactSvetofor_Remont();
	UFUNCTION(BlueprintCallable)
		void rs_AllSvetofor_Remont();

#pragma endregion

#pragma region Signals
	//UFUNCTION(BlueprintCallable)
	//	void rs_RazvorotPeregona(EdopStat dopstat);
	//UFUNCTION(BlueprintCallable)
	//	void rs_VspomogatRazvorotPeregona(EdopStat dopstat);
#pragma endregion
...
#pragma region from N
	UFUNCTION(BlueprintCallable)
		bool rs_N_1P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_N_2P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_N_3P_CheckPossCreate();
...
#pragma region from ND
	UFUNCTION(BlueprintCallable)
		bool rs_ND_1P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_ND_2P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_ND_3P_CheckPossCreate();
...
#pragma region from CH
	UFUNCTION(BlueprintCallable)
		bool rs_CH_1P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_CH_2P_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_CH_3P_CheckPossCreate();
...
#pragma region from M1
	UFUNCTION(BlueprintCallable)
		bool rs_M1_CH1_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_M1_CH2_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_M1_CH3_CheckPossCreate();
...
#pragma region from M2
	UFUNCTION(BlueprintCallable)
		bool rs_M2_N1_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_M2_N2_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_M2_N3_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_M2_M3_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_M2_M5_CheckPossCreate();


#pragma endregion
#pragma region from M3
	UFUNCTION(BlueprintCallable)
		bool rs_M3_M2_CheckPossCreate();
...
#pragma region from CH1
	UFUNCTION(BlueprintCallable)
		bool rs_CH1_M1_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_CH1_N_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_CH1_ND_CheckPossCreate();
#pragma endregion
#pragma region from CH2
	UFUNCTION(BlueprintCallable)
		bool rs_CH2_M1_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_CH2_N_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_CH2_ND_CheckPossCreate();
#pragma endregion
#pragma region from CH3
	UFUNCTION(BlueprintCallable)
		bool rs_CH3_M1_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_CH3_N_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_CH3_ND_CheckPossCreate();
#pragma endregion
...
#pragma region from N1
	UFUNCTION(BlueprintCallable)
		bool rs_N1_M2_CheckPossCreate();
	UFUNCTION(BlueprintCallable)
		bool rs_N1_CH_CheckPossCreate();


#pragma endregion
#pragma region from N2
	UFUNCTION(BlueprintCallable)
		bool rs_N2_M2_CheckPossCreate();

	UFUNCTION(BlueprintCallable)
		bool rs_N2_CH_CheckPossCreate();


#pragma endregion
#pragma region from N3
	UFUNCTION(BlueprintCallable)
		bool rs_N3_M2_CheckPossCreate();

	UFUNCTION(BlueprintCallable)
		bool rs_N3_CH_CheckPossCreate();

	bool rs_M7_CH3_CheckPossCreate();
...
#pragma endregion
	...
	FElm* rs_GetEndRouter(Router* router);

	//Router* rs_GetReadyRouter(EdopStat dopstat);

	UFUNCTION(BlueprintCallable)
		void rs_IskusstvennaiyaRazdelka();
